...
CREATE TABLE `ADRESSE_CONTACT` (
  `ADRESSE_ID` VARCHAR(80) NOT NULL,
  `ADRESSE_CONTACT_ID` VARCHAR(80) NOT NULL,
  PRIMARY KEY (`ADRESSE_ID`, `ADRESSE_CONTACT_ID`),
  CONSTRAINT `fk_ADRESSE_idADRESSE`
    FOREIGN KEY (`ADRESSE_ID`)
    REFERENCES `ADRESSE` (`idADRESSE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ADRESSE_CONTACT_idADRESSE`
    FOREIGN KEY (`ADRESSE_CONTACT_ID`)
    REFERENCES `ADRESSE` (`idADRESSE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
